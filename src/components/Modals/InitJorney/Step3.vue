			...
			return {
				...
				partnerDatabase: [
					{character: "arnold", partners:[
						{number:"1.gif", name:"BULBA", info: "DADO A ARNOLD PELO PROFESSOR CARVALHO, JÁ QUE O GAROTO NÃO POSSUIA POKÉMON PARA A JORNADA DE DESCOBRIMENTO. FOI ESCOLHIDO POR SER MAIS CENTRADO E FICAR AJUDANDO A COLOCAR ORDEM NO LABORATÓRIO. UMA PERSONALIDADE CONTRASTANTE A ATRAPALHADA DE ARNOLD, O QUE FEZ O GAROTO O CONSIDERAR UM BOM PARCEIRO."},
						{number:"4.gif", name:"CHAR", info: "DADO A ARNOLD PELO PROFESSOR CARVALHO, JÁ QUE O GAROTO NÃO POSSUIA POKÉMON PARA A JORNADA DE DESCOBRIMENTO. FOI ESCOLHIDO POR SER UM POUCO ATRAPALHADO, ONDE QUASE SEMPRE QUEIMA ALGO NO LABORATÓRIO COM A CHAMA DA SUA CAUDA SEM QUERER. A PERSONALIDADE FEZ ARNOLD SE COMPADECER COM ELE."},
						{number:"7.gif", name:"SQUIRT", info: "DADO A ARNOLD PELO PROFESSOR CARVALHO, JÁ QUE O GAROTO NÃO POSSUIA POKÉMON PARA A JORNADA DE DESCOBRIMENTO. FOI ESCOLHIDO POR SER BEM BRINCALHÃO, JÁ QUE DE TEMPOS EM TEMPOS JOGA ÁGUA NOS DEMAIS POKÉMONS E PESQUISADORES DO LABORATÓRIO COMO FORMA DE BRINCADEIRA. ARNOLD TEM UM BOM VÍNCULO COM ELE, JÁ QUE É O PRINCIPAL ALVO DAS BRINCADEIRAS."}
					]},
					...
					{character: "erik", partners:[
						{number:"82.gif", name:"MAGNETON", info: "AINDA QUANDO ERA UM MAGNEMITE SEMPRE VISITAVA ERIK A NOITE, DEVIDO A UMA MÁQUINA QUE O GAROTO TINHA CRIADO. APÓS ERIK TER APERFEIÇOADO A MÁQUINA, UMA NOITE SUMIU COM ELA E APARECEU NA NOITE SEGUINTE COMO UM MAGNETON. TAL FATO LEVOU A ERIK COMEÇAR A CUIDAR DELE E CRIAR NOVAS MÁQUINAS PARA VER COMO ELE REAGIA."},
						{number:"299.gif", name:"NOSEPASS", info: "ADOTADO POR ERIK, EM UMA VISITA DO GAROTO A HOENN. ELE ERA O ÚNICO DE UM GRUPO DE 6 NOSEPASS QUE NÃO APONTAVAM PARA O NORTE, O QUE FEZ A CURIOSIDADE DE ERIK SER ACIONADA. COM O PASSAR DO TEMPO, ELE E ERIK ACABARAM SE TORNANDO BONS COMPANHEIROS."},
						{number:"133.gif", name:"EEVEE", info: "FOI DADO PELO SEU PAI DEVIDO AO INTERESSE DE ERIK SOBRE EVOLUÇÕES DE POKÉMON. COSTUMA TENTAR BRINCAR COM ERIK, IGNORANDO TODOS OS BRINQUEDOS QUE O RAPAZ CRIOU PARA ELE. MESMO PARECENDO IGNORANDO, ELE E ERIK NUTREM UM CARRINHO UM PELO OUTRO."}
					]},
					...
					{character: "luna", partners:[
						{number:"30.gif", name:"RINA", info: "UMA NIDORAN QUE ACOMPANHA LUNA DESDE OS 5 ANOS DA MENINA. SEMPRE TEVE MUITA ATENÇÃO DOS AMIGOS DE LUNA POR SER UM POKÉMON DIFERENCIADO NA REGIÃO DE HOENN, PORÉM MESMO COM TODA A ATENÇÃO SE MANTEVE HUMILDE E ALEGRE ASSIM COMO SUA DONA, A QUAL TEM UMA RELAÇÃO DE IRMANDADE."},
						{number:"35.gif", name:"FARY", info: "AINDA QUANDO CLEFFA FOI DADA A LUNA POR SEU PAI, SE TORNANDO DESDE O PRIMEIRO DIA INSEPARÁVEL DE LUNA. COM O PASSAR DO TEMPO EVOLUI PARA CLEFAIRY, E COM ISSO PASSOU A TER UM SENTIMENTO MAIS PROTETORA COM LUNA. DEIXANDO ASSIM DE SE CONSIDERAR A IRMÃ MAIS NOVA PARA SE CONSIDERAR A MAIS VELHA DA RELAÇÃO."},
						{number:"300.gif", name:"KITTY", info: "UMA DAS FILHAS DA DELCATT DA MÃE DE LUNA. ACOMPANHA LUNA DESDE OS 7 ANOS DA MENINA, A CONSIDERANDO ATÉ UMA DE SUAS IRMÃS. TEM UM PERSONALIDADE CIUMENTA, MAS CONSEGUE ENTENDER QUE LUNA NÃO PODE DAR ATENÇÃO SEMPRE PARA ELA...PELO MENOS FINGE QUE ENTENDE."}
					]},
